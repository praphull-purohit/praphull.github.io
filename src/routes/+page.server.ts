...
const getInfo = () => {
    ...
    const info: Info = {
        tags: [
            ...
            { name: "Akka Streams", title: "Akka Streams", hash: "akka-streams" },
            { name: "Akka Actors", title: "Akka Actors", hash: "akka-actors" },
