<script lang="ts">
    ...
    import AboutMe from "$lib/static/AboutMe.svelte";
...
<div class="section">
<div class="columns">
    <div class="column is-3-desktop is-3-tablet is-full-mobile">
        <Intro />
    </div>
    <div class="column is-9-desktop is-9-tablet is-full-mobile">
        <div class="columns">
